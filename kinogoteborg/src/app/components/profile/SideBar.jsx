export default function SideBar({ setPage }) {
  ...
  return (
    <aside className="h-{400px} w-full bg-slate-500 sm:h-full flex flex-col py-4 grid-span-1">
      ...
      >
        <h3 className="bg-white bg-opacity-10 sm:p-2 hover:bg-opacity-20 hover:cursor-pointer rounded-md py-2 sm:pl-4">
          General
        </h3>
        {/* Shows user information */}
        <h3 className="bg-white bg-opacity-10 sm:p-2 hover:bg-opacity-20 hover:cursor-pointer rounded-md pl-0 py-2 sm:pl-4">
          Bookings
        </h3>
